---
title: Build CLIs with quo
date: 2022-02-25 00:00
description: Learn the basics of building CLIs with quo.
tags: Python, CLI 
path: build-clis-with-quo-python
...
## Compatibility
Quo works with Linux, OSX, and Windows and requires Python `3.8` or later. 


## Features
- [x] Support for ANSI, RGB and text and tuples color models
